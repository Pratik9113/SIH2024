          ...
          <li key={index} className="p-4 bg-gray-100 border border-gray-300 rounded-lg hover:bg-gray-200 transition duration-300">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center">
              ...
              <div className="mt-4 md:mt-0 md:block md:items-center">
                ...
                <div className="p-3">
                  <img className='cursor-pointer w-10 h-10 rounded-full border-4 border-gray-300 shadow-lg object-cover' src={assets.whatsapp} alt="Connect with Whatsapp" onClick={() => handleWhatsAppClick(lawyer.contactDetails.phone)} />
                </div>
              </div>
            </div>
          </li>
